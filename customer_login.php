...
<style type="text/css">			
	...
	<body>
		...
		<div class="container">
    <h1 class="welcome text-center" align="center" style="color: black">Welcome to <br> the Canteen of PDA College</h1>
        <div class="card card-container">
        <h2 class='login_title text-center' align="center" style="color: darkgrey">Login using your USN NUMBER</h2>
       

            <form class="form-signin" method="POST">
                <span id="reauth-email" class="reauth-email"></span>
                <p class="input_title">USN</p>
